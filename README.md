...
To update the database use this command from the Web project folder (replace `TNK` with your project's name):

```powershell
dotnet ef database update -c AppDbContext -p ../TNK.Infrastructure/TNK.Infrastructure.csproj -s TNK.Web.csproj
```
