...
namespace TNK.Infrastructure.Data.Migrations
{
    ...
    [Migration("20250605183528_AddedWorkerServices")]
    partial class AddedWorkerServices
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ServiceWorker", b =>
                {
                    b.HasOne("TNK.Core.ServiceManagementAggregate.Entities.Service", null)
                        .WithMany()
                        .HasForeignKey("ServicesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("TNK.Core.ServiceManagementAggregate.Entities.Worker", null)
                        .WithMany()
