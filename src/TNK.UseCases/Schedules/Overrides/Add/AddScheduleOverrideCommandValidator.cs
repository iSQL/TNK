...
public class AddScheduleOverrideCommandValidator : AbstractValidator<AddScheduleOverrideCommand>
{
  public AddScheduleOverrideCommandValidator()
  {
    ...
    RuleFor(x => x.OverrideDate)
        .NotEmpty().WithMessage("Override date is required.");
